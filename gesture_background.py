...
class GestureBackground:
    ...
    def draw(self):
        self.check_image.clip_draw(0,0,check_image_width,check_image_height,canvaswidth//2,self.check_image_y,check_image_width*0.4,check_image_height*0.4)
        self.canvas_image.draw(canvaswidth//2,self.canvas_image_y)
        pass